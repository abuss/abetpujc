...
DROP TABLE IF EXISTS DEFEVALUACIONES;
...
(
	...
	-- Ej. A1
	ID_INDDESEMP TEXT NOT NULL,
	-- Ej. 30
	PORCINDICADOR INT NOT NULL,
...
(
	...
	FOREIGN KEY (ID_ASIG, GRUPO_ASIG, ID_EVAL, ID_INDDESEMP)
	REFERENCES DEFEVALUACIONES (ID_ASIG, GRUPO_ASIG, ID_EVAL, ID_INDDESEMP),
